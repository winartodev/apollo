...
BEGIN
    ...
    INSERT INTO services (slug, name, is_active, created_by, updated_by, created_at, updated_at)
        VALUES ('service-a', 'Service A', true,super_user_id, super_user_id, current_epoch_time, current_epoch_time),
               ('service-b', 'Service B', true,super_user_id, super_user_id, current_epoch_time, current_epoch_time),
               ('service-c', 'Service C', false,super_user_id, super_user_id, current_epoch_time, current_epoch_time);
